                ...
                if(rs.getString("status").equals("approved")) {
                    ...
                    u.activate(user); 
                        ...
                        System.out.println(ex.getMessage());
                            ...
                            + "<input type=\"number\" step=\"0.01\" name=\"amint\" placeholder=\"Enter Amount\" class=\"tfd\" /><p/>"
                        ...
                        System.out.println(ex.getMessage());
                            ...
                            if(request.getParameter("civ")!=null && request.getParameter("amo")!=null) {
                                ...
                                if(rs5.next()) {
                                    ...
                                    if(Float.valueOf(rs.getString("main"))>=Float.valueOf(request.getParameter("amo"))) {
                                        try {
                                    
                                    if(u.IsActive(user)) {
                                    //let us do the update on balance
                                    Float balnow=Float.valueOf(rs.getString("main"))-Float.valueOf(request.getParameter("amo"));

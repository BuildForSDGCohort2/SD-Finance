            ...
            if(rs.next()) {
                if(rs.getString("status").equals("approved")) {
                    ...
                    body="<hr/><p/><table border=\"0\" cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"white\" width=\"100%\">"
                            ...
                            + "<table border=\"8\" bordercolor=\"purple\" \"cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"darkgreen\" width=\"100%\"> <tr>";
                            ...
                            if(request.getParameter("mssg")!=null && request.getParameter("tit")!=null) {
                                ...
                                PreparedStatement pst8=con.prepareStatement("select *from messages where ID=? && own=?");
                                pst8.setString(1,request.getParameter("mssg")); pst8.setString(2,user);
                                
                                ResultSet rs8=pst8.executeQuery(); rs8.last();
                                
                                if(rs8.last()) {
                                if(request.getParameter("mg")!=null && !rs8.getString("message").startsWith(request.getParameter("mg").replaceAll("\n","<p/>"))) {
                                ...
                                body=body+"<form name=\"msge\" action=\"messages\" method=\"post\" onsubmit=\"return(msgvl())\" >"
                                        ...
                                        + "By clicking send below you agree to the <a href=\"terms.html\">terms and conditions</a> as stated by SD Finance.<p/>"

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("type").equals("signup")) {
            ...
            if(!u.Exists(lst1, request.getParameter("email"))) 
            {
                ...
                pst2.setString(9, request.getParameter("pass")); pst2.setString(10, "0.00");
                pst2.setString(11, "0"); pst2.setString(12, "0");
                pst2.setString(13, "client"); pst2.setString(14, "approved");
                
                pst2.executeUpdate();
                
                //add to sessions too
                PreparedStatement pst8=con.prepareStatement("insert into session(Email,Status) values(?,?)");
                pst8.setString(1,request.getParameter("email")); pst8.setString(2,"active");
                ...
                body=body+""
                        ...
                        + "been created. <p/>Your account is now under review before it is approved. This will be completed within less than a minute.<br/>"
                        ...
                        + "<a href=\"sign.html\"><button class=\"btn\">Sign In</button></a><hr/>";
                ...
                body=body+""
                        ...
                        + "If its your account, please <a href=\"sign.html\">Sigin In</a> right away. Else, please review your email and "

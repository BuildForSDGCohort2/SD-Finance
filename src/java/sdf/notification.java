            ...
            if(rs.next()) {
                if(rs.getString("status").equals("approved")) {
                    ...
                    body="<hr/><p/><table border=\"0\" cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"white\" width=\"100%\">"
                            ...
                            //Here is my body
                            "<p class=\"hedi\">Review Your Notications</p><hr/>"
                            + "<table border=\"8\" bordercolor=\"darkslateblue\" cellpadding=\"8\" cellspacing=\"8\" width=\"100%\" bgcolor=\"lightslategrey\">";
                    
                    //let us call dem notifications
                    PreparedStatement pst3=con.prepareStatement("select *from notification where own=?");
                    pst3.setString(1,user); ResultSet rs3=pst3.executeQuery();
                    
                    rs3.last();
                    
                    if(rs3.last()) {
                        body=body+"<tr><th class=\"trn\" bgcolor=\"deepskyblue\"><h3>"+rs3.getString("title")+"</h3>"+rs3.getString("content")+"</th></tr>";
                    }
                    if(rs3.previous()) {
                        body=body+"<tr><th class=\"trn\" bgcolor=\"deepskyblue\"><h3>"+rs3.getString("title")+"</h3>"+rs3.getString("content")+"</th></tr>";
                    }
                    ...
                    String content=u.head1+hom+u.head2+btn+u.head3+"NOTIFICATIONS"+u.comph+body+u.foot1+hom+u.foot2;

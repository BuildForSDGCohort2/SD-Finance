                    ...
                    u.activate(user); 
                        ...
                        System.out.println(ex.getMessage());
                            ...
                            if(request.getParameter("pay")!=null) {
                                ...
                                if(Float.valueOf(rs.getString("main"))>=Float.valueOf(request.getParameter("amti"))) { 
                                ...
                                //On Both clients
                                Float a=null,b=null,c=null; String fro=null,to=null;
                                ...
                                if(rs6.next()) {
                                    ...
                                    c=Float.valueOf(rs6.getString("amount"));
                                ...
                                if(rs7.next()) {
                                    ...
                                    a=Float.valueOf(rs7.getString("main")) - c;
                                ...
                                if(rs8.next()) {
                                    ...
                                    b=Float.valueOf(rs8.getString("main")) + c;

...
public class Demo extends HttpServlet {
            ...
            if(rs.next()) {
                if(rs.getString("status").equals("approved")) {
                    ...
                    body="<hr/><p/><table border=\"0\" cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"white\" width=\"100%\">"
                            ...
                            pst3.setString(1,"1000.00"); pst3.setString(2,user);
                            
                            //Let's reset this staff
                            pst3.executeUpdate();
                            
                            body=body+"<font face=\"Cambria\" size=\"+2\" color=\"green\">Success!</font><hr/>"
                                    + "Your account has been successfully reset to $1000 to continue testing this project.<hr/>"
                                    + "<a href=\"login\"><button class=\"btn2\">OK Thanks</button></a><hr/>";
    ...
    public String getServletInfo() {
        return "Demonstration Of Project By reseting balance to $1000";
    }

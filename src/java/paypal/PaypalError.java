            ...
            if(rs.next()) {
                if(rs.getString("status").equals("approved")) {
                    ...
                    body="<hr/><p/><table border=\"0\" cellpadding=\"3\" cellspacing=\"3\" bgcolor=\"white\" width=\"100%\">"
                            ...
                            //Here is my body
                            "<p class=\"hhdd\">Paypal Payment Error</p><hr/>"
                            + "<p>"+request.getAttribute("errorMessage").toString()+"</p><hr/>"
                            + "<a href=\"receive\"><button class=\"btn2\">Ok Return</button></a><hr/>";
                    
                    //we do the output stream
                    String content=u.head1+hom+u.head2+btn+u.head3+"ERROR!"+u.comph+body+u.foot1+hom+u.foot2;
